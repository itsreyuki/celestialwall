...
function geometry(node, element) {
  ...
  node.style.color = element.style.color || ''; node.style.backgroundColor = element.type === 'social-links' ? '' : (element.style.backgroundColor || ''); node.style.opacity = element.style.opacity ?? '';
